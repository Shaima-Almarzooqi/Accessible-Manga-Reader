...
class ReprocessDialog(wx.Dialog):
    def __init__(self, parent, book, current_page=None):
        ...
        choices.append("The &whole book (clears the AI's character notes)")
        ...
        note = wx.StaticText(
            panel,
            label="Reprocessing sends those pages to the AI again and "
                  "uses your API quota. The pages you choose are "
                  "replaced; the rest of the book is left alone.")
        note.Wrap(460)
    ...
    def on_ok(self, event):
        ...
        if scope == "whole":
            answer = wx.MessageBox(
                "Reprocess the whole book? This clears all %d processed "
                "pages and the AI's character notes for this book, then "
                "processes every page again."
