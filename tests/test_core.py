...
class TestLanguageSetting(unittest.TestCase):
    ...
    def test_names_are_kept_in_original_form(self):
        prompt = prompts.build_system_prompt("manga", "detailed", "English")
        self.assertIn("kept in their original form are proper names",
                      prompt)
